        ...
        public async Task<ActionResult> GetCombinedPercentages(int projectId)
        {
            ...
            foreach (var quantitySheet in quantitySheets)
            {
                ...
                lots[lotNumber][quantitySheet.QuantitySheetId] = new
                {
                    ...
                    InterimQuantity = interimQuantity, // InterimQuantity added
                    PercentageCatch = quantitySheet.PercentageCatch // Include PercentageCatch for each QuantitySheetId
                };
            ...
            return Ok(new
            {
                ...
                Lots = lots // Include detailed lots with InterimQuantity and PercentageCatch
            });
        }
